...
exports.home = function(req, res) {
    ...
    if (typeof req.session.username == 'undefined') res.render('home', { title: 'Expr'});
...
exports.page = function(req, res) {
    ...
    var contents = {
        about: 'Ninja Store sells the coolest ninja stuff in the world. Anyone shopping here is cooll.',
